  ...
  return (
    <>  
            <div className='my-[20px] py-[50px]'>
                <div className='outerctasection w-[80%] mx-auto grid md:grid-cols-[40%_60%] grid-cols-1 justify-center items-center' >
                        <div className='w-[100%]'>
                            <img src="contactImg.png" alt="contactusimg" className='w-[100%] rounded-tr-3xl md:rounded-none ctaimage'/>
                        </div>


                        <div className=''>
                            <h2 className='font-bold text-3xl text-center py-[30px]'>Free Consultation</h2>
                            <form action="" className=' lg:w-[80%] w-[90%] mx-auto '>
                            ...
                            <div className='font-bold py-[45px] text-center w-[100%]'>
