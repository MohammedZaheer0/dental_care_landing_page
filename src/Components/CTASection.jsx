                ...
                <div className='outerctasection max-w-[95%] lg:max-w-[80%] mx-auto grid md:grid-cols-[40%_60%] grid-cols-1 justify-center items-center' >
                        ...
                        <div className=''>
                            ...
                            <div className='grid sm:grid-cols-2 sm:gap-5 grid-cols- gap-2'>
                                <input type="text" placeholder='Full Name*' required className='p-[15px] my-[10px] border-[1px] border-[lightgray] outline-none rounded-2xl'/>
                                <input type="text" placeholder='Im Intrested In*' required className='p-[15px] my-[10px] border-[1px] border-[lightgray] outline-none rounded-2xl'/>
                                <input type="email" placeholder='Email*' required className='p-[15px] my-[10px] border-[1px] border-[lightgray] outline-none rounded-2xl'/>
                                <input type="phone" placeholder='Phone Number*' required className='p-[15px] my-[10px] border-[1px] border-[lightgray] outline-none rounded-2xl'/>
                            </div>                                
                            <div className='font-bold py-[40px] text-center max-w-[100%]'>
